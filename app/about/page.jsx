    ...
    <div>
      ...
      <div className="container">
        <div className="pt-4">
          ...
          >
            Our interiror design company is a company that provides interior
            design services for homes, offices, apartments, and others. We
            provide the best interior design services for your. we have a team
            that is experienced in the field of interior.
          </motion.p>
        </div>
        <div className="items-center lg:flex gap-x-8">
          {/* Left Image section  */}
          <motion.div style={{ scale }} ref={ref}>
