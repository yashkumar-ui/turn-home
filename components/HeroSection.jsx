    ...
    <div className="container py-12 xl:py-24 h-auto text-center lg:py-0 lg:text-left lg:flex lg:justify-between">
      ...
      <div className="lg:w-1/2 xl:py-14 lg:py-8">
        ...
        >
          ...
          We provide the best interior design for youe Home. Make every moment
      ...
      <div className="w-1/2">
        <Image
          ...
          height={500}
          alt=""
          className="absolute ring-20 xl:h-[448px] xl:w-[700px] lg:h-[334px] lg:w-[500px] hidden lg:block "
        />
      </div>
    </div>
  );
